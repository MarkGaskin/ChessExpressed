// Originally taken from https://github.com/swlaschin/DomainModelingMadeFunctional/blob/master/src/OrderTaking/Result.fs
// which requires the following blurb to satisfy Apache Licensing:
(*
Copyright 2020 Prolucid Technologies Inc
...
Changes:
    - Removed commented code and related comments referring to older versions of F#
*)
...
module AsyncResultComputationExpression =
    ...
    type AsyncResultBuilder() =
        ...
        member __.Delay(f) = async { return! f () }
